  ...
  return (
    <div id="hero" className="py-32 md:py-48 lg:py-60 relative z-0 overflow-x-clip">
      ...
      <div className="max-w-lg mx-auto">
        <h1 className="font-serif text-3xl md:text-5xl text-center mt-8 tracking-wide">Full-Stack Web Developer</h1>
        <p className="mt-4 text-center text-white/60 md:text-lg">{'I\'m passionate about learning and building functional, high-performing applications. Let\'s connect and grow together!'}</p>
      </div>
      <div className="flex flex-col md:flex-row justify-center items-center mt-8 gap-4">
        ...
        <button className="inline-flex items-center gap-2 border border-white bg-white text-gray-900 h-12 px-6 rounded-xl">
          <a
            href="mailto:avuthutejavardhanreddy@gmail.com?subject=Let's%20Work%20Together"
          >
            <span>👋</span>
